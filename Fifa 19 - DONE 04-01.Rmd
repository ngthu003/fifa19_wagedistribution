...
# library("rstudioapi", lib="C:/Rpackages")
# library("tidyr", lib="C:/Rpackages")
# library("tidyverse", lib="C:/Rpackages")
...
```{r echo=FALSE}
original_club_names <- c('Atlético Madrid', 'FC Bayern München', 'AS Saint-�???tienne', '1. FC Köln', 'CD Leganés', '1. FC Nürnberg', 'Deportivo Alavés', 'Borussia Mönchengladbach', 'Nîmes Olympique')
